...
import { IndianRupee, Blinds } from 'lucide-react'
    ...
    return (
        <>
            <div  className="relative mx-auto w-full">
                <Link href={`/propertyList/${props._id}`} className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
