...
import { IndianRupee, Blinds, Pencil, Trash2 } from 'lucide-react'
import Image from 'next/image'
import Link from 'next/link'

const userPropertyCard = (props) => {
    // console.log(props.coverImg[0])
    const deletProperty = () => {
    ...
    return (
        <>
            <div className="relative mx-auto w-full">
                <Link href={`/yourPropertyList/${props._id}`} className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
                    <div className="shadow p-4 rounded-lg bg-white">
                        <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                            <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                                {/* <div className="absolute inset-0 bg-black opacity-10"></div> */}
                                <Image className='absolute inset-0' src={props.coverImg[0] } width={500} height={500} alt="Picture of yhe property"/>
                            </div>
                            ...
                            <span className="absolute top-0 left-0 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-white text-sm font-medium text-white select-none space-x-2">
                            <Trash2 onClick={deletProperty} size={16} color="#000000"/>
                        ...
                        <div className="grid grid-cols-2 mt-8">
                            ...
                            <div className="flex justify-end">
                                <p className=" font-semibold text-primary whitespace-nowrap leading-tight rounded-xl flex items-center">
                                    <span>
                                    <IndianRupee size={20} />
                                    </span>
